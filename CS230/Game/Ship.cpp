...
//Ship::Ship(Math::vec2 start_position) : /*start_position(start_position), */position(start_position) {
//    velocity = { 0,0 };
//    leftflame = false;
//    rightflame = false;
//    sprite.Load("Assets/Ship.spt");
...
//    flame_left.Draw(camera_matrix * object_matrix * Math::TranslationMatrix(sprite.GetHotSpot(1)));
//    flame_right.Draw(camera_matrix * object_matrix * Math::TranslationMatrix(sprite.GetHotSpot(2)));
//}
    ...
    GameObject(position, rotation, ship_scale)
{
    ...
    //AddGOComponent(new CS230::Sprite("Assets/Ship.spt"));
    //flame_left.Load("Assets/Flame.spt");
    //flame_right.Load("Assets/Flame.spt");
    //sprite.Load("Assets/Ship.spt");
}
...
void Ship::Update(double dt) {
    ...
    if (exploded == false) {
        ...
        if (Engine::GetInput().KeyDown(CS230::Input::Keys::A)) {
            ...
            //flame_right.PlayAnimation(static_cast<int>(Flame_Animations::Flame));
            //if (Engine::GetInput().KeyDown(CS230::Input::Keys::A) == false) {
            //    flame_right.PlayAnimation(static_cast<int>(Flame_Animations::None));
            //}
        ...
        if (Engine::GetInput().KeyDown(CS230::Input::Keys::D)) {
            SetRotation(GetRotation() - rotation_speed * dt);
            //flame_left.PlayAnimation(static_cast<int>(Flame_Animations::Flame));
            //if (Engine::GetInput().KeyDown(CS230::Input::Keys::D) == false) {
            //    flame_left.PlayAnimation(static_cast<int>(Flame_Animations::None));
            //}
            //angle -= rotation_speed * dt;
        }
    ...
    //{
    //    SetPosition({ GetPosition().x + GetScreenWidth() + GetGOComponent<CS230::Sprite>()->GetFrameSize().x, GetPosition().y });
    //}
    //if (GetPosition().x - GetGOComponent<CS230::Sprite>()->GetFrameSize().x / 2.0 > GetScreenWidth())
    //{
    //    SetPosition({ GetPosition().x - GetScreenWidth() - GetGOComponent<CS230::Sprite>()->GetFrameSize().x, GetPosition().y });
    //}
    //if (GetPosition().y + GetGOComponent<CS230::Sprite>()->GetFrameSize().y / 2.0 < 0)
    //{
    //    SetPosition({ GetPosition().x, GetPosition().y + GetScreenHeight() + GetGOComponent<CS230::Sprite>()->GetFrameSize().y });
    //}
    //if (GetPosition().y - GetGOComponent<CS230::Sprite>()->GetFrameSize().y / 2.0 > GetScreenHeight())
    //{
    //    SetPosition({ GetPosition().x, GetPosition().y - GetScreenHeight() - GetGOComponent<CS230::Sprite>()->GetFrameSize().y });
    //}
    ...
    //if (position.x + sprite.GetFrameSize().x / 2.0 < 0)
    //{
    //    position.x += GetScreenWidth() + sprite.GetFrameSize().x;
    //}
    //if (position.x - sprite.GetFrameSize().x / 2.0 > GetScreenWidth())
    //{
    //    position.x -= GetScreenWidth() + sprite.GetFrameSize().x;
    //}
    //if (position.y + sprite.GetFrameSize().y / 2.0 < 0)
    //{
    //    position.y += GetScreenHeight() + sprite.GetFrameSize().y;
    //}
    //if (position.y - sprite.GetFrameSize().y / 2.0 > GetScreenHeight())
    //{
    //    position.y -= GetScreenHeight() + sprite.GetFrameSize().y;
    //}
}
