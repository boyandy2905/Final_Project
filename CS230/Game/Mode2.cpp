...
//Mode2::Mode2() : ship({ static_cast<double>(Engine::GetWindow().GetSize().x) / 2, static_cast<double>(Engine::GetWindow().GetSize().y) / 2 }) {
//
//}
...
void Mode2::Load() {
    ...
    //ship.Load();
    //gameobjectmanager.Add(new Ship({ static_cast<double>(Engine::GetWindow().GetSize().x) / 2.0, static_cast<double>(Engine::GetWindow().GetSize().y) / 2.0 }, 0.0, { 0.75, 0.75 }));
    //gameobjectmanager.Add(new Meteor());
    //gameobjectmanager.Add(new Meteor());
    //gameobjectmanager.Add(new Meteor());
    //gameobjectmanager.Add(new Meteor());
    //gameobjectmanager.Add(new Meteor());
    //GetGSComponent<CS230::GameObjectManager>()->Add(new Ship({ static_cast<double>(Engine::GetWindow().GetSize().x) / 2.0, static_cast<double>(Engine::GetWindow().GetSize().y) / 2.0 }, 0.0, { 0.75, 0.75 }));
