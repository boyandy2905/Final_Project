...
//}
//
//void CS230::Sprite::Load(const std::filesystem::path& texture_path, std::initializer_list<Math::ivec2> spots) {
//	texture.Load(texture_path);
...
//	texture.Draw(display_matrix * Math::TranslationMatrix(-hotspots[0]));
//}
...
//    texture->Draw(position - static_cast<Math::vec2>(hotspots[0]));
//    //texture.Draw(position - static_cast<Math::vec2>(hotspots[0]));
//}
